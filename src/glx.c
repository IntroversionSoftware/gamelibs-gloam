...
static int gloam_glx_get_extensions(GloamGLXContext *context, Display *display, int screen, uint64_t **out_exts, uint32_t *out_num_exts)
{
    const char *ext_str;
...
static int gloam_glx_find_extensions_glx(GloamGLXContext *context, Display *display, int screen)
{
    ...
    if (!gloam_glx_get_extensions(context, display, screen, &exts, &num_exts))
        return 0;
